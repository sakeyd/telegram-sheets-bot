...
SHEET_NAME = "Актуальное_расписание"

# Получим JSON из Secrets
SERVICE_ACCOUNT_JSON = os.environ.get("GOOGLE_SERVICE_ACCOUNT")
if not SERVICE_ACCOUNT_JSON:
    raise ValueError("GOOGLE_SERVICE_ACCOUNT не установлена в Secrets")
...
def main():
    ...
    logging.info("🚀 Запуск оптимизированного бота на Replit...")
    
    # Проверка переменных окружения
    if not BOT_TOKEN:
        logging.error("❌ TELEGRAM_BOT_TOKEN не установлен в Secrets")
        return
    if not SPREADSHEET_ID:
        logging.error("❌ SPREADSHEET_ID не установлен в Secrets")
        return
    ...
    print("=" * 50)
    print("🚀 Telegram Бот-ежедневник")
    print("📅 С интеграцией Google Sheets")
    print("⏰ Работает 24/7 на Replit")
    print("=" * 50)
...
if __name__ == '__main__':
    print("=" * 50)
    print("🚀 Telegram бот запущен на Replit")
    print("📅 Интеграция с Google Sheets")
    print("=" * 50)
    
    # Проверка переменных
    print(f"✅ TELEGRAM_BOT_TOKEN: {'Установлен' if BOT_TOKEN else '❌ Отсутствует'}")
    print(f"✅ SPREADSHEET_ID: {'Установлен' if SPREADSHEET_ID else '❌ Отсутствует'}")
    print(f"✅ GOOGLE_SERVICE_ACCOUNT: {'Установлен' if SERVICE_ACCOUNT_JSON else '❌ Отсутствует'}")
    print("=" * 50)
